...
urlpatterns = [
    ...
    path('hikvision_api/', views.hikvision_api,name='hikvision_api'),
    ...
    path('active-members-edit/<int:update_id>', views.active_members_edit,name='active_members_edit'),
    path('active-members-delete/<int:dlt_id>', views.active_members_delete,name='active_members_delete'),

    path('inactive-members/', views.inactive_members,name='inactive_members'),
    path('inactive-members-edit/<int:update_id>', views.inactive_members_edit,name='inactive_members_edit'),
    path('inactive-members-delete/<int:dlt_id>', views.inactive_members_delete,name='inactive_members_delete'),
    ...
    path('receptionist-edit/<int:id>', views.receptionist_edit,name='receptionist_edit'),
    path('receptionist-delete/<int:usr_id>/', views.receptionist_delete,name='receptionist_delete'),

    path('otherstaff-register/', views.otherstaff_register,name='otherstaff_register'),
    path('other-staff-edit/<int:id>', views.other_staff_edit,name='other_staff_edit'),
    path('other-staff-delete/<int:usr_id>/', views.other_staff_delete,name='other_staff_delete'),
    ...
    path('trainer-delete/<int:usr_id>/', views.trainer_delete,name='trainer_delete'),
    ...
    path('salaray-management-bill-generation/<int:bill_id>/', views.salaray_management_bill_generation,name='salaray_management_bill_generation'),
    path('salary-management-bill-generation-print/<int:bill_id>/', views.salary_management_bill_generation_print,name='salary_management_bill_generation_print'),
    ...
    path('membership-expiry-status-change', views.membership_expiry_status_change,name='membership_expiry_status_change'),
    ...
    path('enquiry-followup-edit/<int:update_id>/', views.enquiry_followup_edit,name='enquiry_followup_edit'),
